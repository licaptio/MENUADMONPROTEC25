...
export function actualizarResumen(resumen) {
  ui.totalSeleccionados.textContent = resumen.seleccionados;
  ui.totalValidos.textContent = resumen.validos;
  ui.totalSupabase.textContent = resumen.supabase;
  ui.totalFirebase.textContent = resumen.firebase;
}
