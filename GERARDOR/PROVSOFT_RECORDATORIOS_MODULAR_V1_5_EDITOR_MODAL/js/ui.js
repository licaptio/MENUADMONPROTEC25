...
export function renderizarRecordatorios(recordatorios, estado = "PENDIENTE") {
  ...
  if (!recordatorios.length) {
    ...
    listaRecordatorios.innerHTML = `<div class="empty">No hay recordatorios ${esAtendidos ? "atendidos" : "pendientes"}.</div>`;
    return;
  }
  ...
  if (esAtendidos) {
    resumen.innerHTML = `<span class="badge">${recordatorios.length} atendidos</span><span class="badge">Se pueden editar o revivir</span>`;
  } else {
    resumen.innerHTML = `
